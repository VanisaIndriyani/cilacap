...
@section('content')
    <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-6 px-0">
        <div>
            <h1 class="text-2xl font-bold tracking-tight">Tambah Wisata</h1>
            <div class="mt-1 text-sm text-slate-500">Lengkapi data destinasi wisata.</div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.destinations.store') }}" enctype="multipart/form-data" class="space-y-5">
        @csrf
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6 shadow-md">
            ...
            <div class="grid gap-4 sm:gap-5 sm:grid-cols-1 lg:grid-cols-2">
                <div class="sm:col-span-1">
                    ...
                    <input name="name" id="destinationName" value="{{ old('name') }}" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                </div>
                <div class="sm:col-span-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        <input name="slug" id="destinationSlug" value="{{ old('slug') }}" class="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                ...
                <div class="sm:col-span-1">
                    ...
                    <select name="destination_category_id" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->id }}" @selected(old('destination_category_id') == $cat->id)>{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="sm:col-span-1">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="short_description" id="shortDescription" rows="3" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">{{ old('short_description') }}</textarea>
                </div>
                <div class="sm:col-span-2">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6 shadow-md">
            ...
            <div class="grid gap-4 sm:gap-5 sm:grid-cols-1 lg:grid-cols-2">
                ...
                <div class="sm:col-span-1">
                    ...
                    <input name="opening_hours" value="{{ old('opening_hours') }}" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                </div>
                <div class="sm:col-span-1">
                    <label class="text-sm font-semibold text-slate-700 mb-2 block">Harga Tiket</label>
                    <input name="ticket_price" value="{{ old('ticket_price') }}" inputmode="numeric" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                </div>
                <div class="sm:col-span-2">
                    <label class="text-sm font-semibold text-slate-700 mb-2 block">Fasilitas (pisahkan dengan koma / baris baru)</label>
                    <textarea name="facilities_text" rows="3" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">{{ old('facilities_text') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-6 shadow-md">
            ...
            <div class="grid gap-4 sm:gap-5 sm:grid-cols-1 lg:grid-cols-2">
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        <input name="meta_title" id="metaTitle" value="{{ old('meta_title') }}" class="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
