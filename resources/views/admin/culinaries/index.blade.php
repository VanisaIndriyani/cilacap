        ...
        <form method="GET" class="grid gap-4 lg:grid-cols-4">
            <div class="lg:col-span-2">
                <div class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                    ...
                    <input name="q" value="{{ $filters['q'] }}" placeholder="Cari kuliner..." class="w-full bg-transparent text-sm outline-none">
                </div>
            </div>
            <div>
                        ...
                        <tr class="border-b border-slate-200 last:border-b-0 transition hover:bg-slate-50">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.culinaries.destroy', $c->id) }}" onsubmit="return confirm('Yakin ingin menghapus kuliner ini?')">
                                        @csrf
                                        @method('DELETE')
