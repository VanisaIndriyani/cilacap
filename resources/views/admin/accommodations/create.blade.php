        ...
        <div class="rounded-3xl border border-[--color-border] bg-[--color-surface] p-6 shadow-sm">
            <div class="grid gap-5 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <input name="purchase_link" type="url" value="{{ old('purchase_link') }}" placeholder="https://www.agoda.com/..." class="mt-2 w-full rounded-2xl border border-[--color-border] bg-[--color-bg] px-4 py-3 text-sm">
